...
const GestionLeadsBDD = React.memo(({ activeTab, user, isDarkMode }) => {
  ...
  useEffect(() => {
    if (supabase) {
      let timeoutId;
      const ch = supabase
        .channel('crm_leads_bdd_rt')
        .on('postgres_changes', { event: '*', schema: 'public', table: 'crm_leads_bdd' }, (payload) => {
...
export default GestionLeadsBDD;
